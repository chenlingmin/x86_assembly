...
alloc_inst_a_page:                              ;分配一个页，并安装在当前活动的层级分页
        ...
        test dword [esi], 0x00000001            ;P位是否为"1"。检查该线性地址是否已经有
        jnz .b1                                 ;对应的页表
    ...
    .b1:
        ...
        mov esi, ebx
        shr esi, 10
        and esi, 0x003ff000                     ;或者0xfffff000,因为高10位是0
...
load_relocate_program:                          ;加载并重定位用户程序
    ...
    .b1:
        ...
        add ebx, 0x1000
        test eax, 0x00000fff                    ;程序的大小正好是4KB的倍数么？
    ...
    .b3:
        ...
        ;在用户任务的局部地址空间内创建LDT
        mov ebx, [es:esi+0x06]                  ;在TCB中取得可用的线性地址
        add dword [es:esi+0x06], 0x1000
        call sys_routine_seg_sel:alloc_inst_a_page
        ...
        mov edx, [es:esi+0x06]                  ;堆栈的高端线性地址地址
...
start:
    ...
    .b1:
        ...
        mov dword [es:ebx+0], 0x000210003       ;写入目录项（页表的物理地址和属性）
    ...
    .b4:
        ...
        call sys_routine_seg_sel:make_seg_descriptor
        call sys_routine_seg_sel:set_up_gdt_descriptor
        mov [program_man_tss+0x04], cx          ;保存程序管理器的TSS描述符选择子
